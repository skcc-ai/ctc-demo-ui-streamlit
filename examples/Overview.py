...
scenarios = [
    ...
    },
    {
        "num": "SCENARIO 02",
        "icon": "🏢",
        "title": "신규 거래처 리스크 평가 및 등록 마법사 (Supplier Onboarding Wizard)",
        "context": "구매팀이 긴급 자재 수급을 위해 처음 보는 업체인 '퓨처테크'와 거래를 터야 합니다. 급하지만 부실 기업이나 사기 업체일 위험을 피하기 위해, AI를 통해 빠르고 깊이 있게 검증하려 합니다."
    },
    {
        "num": "SCENARIO 03",
        "icon": "🔍",
